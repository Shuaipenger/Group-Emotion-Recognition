...
model2.load_state_dict(torch.load('../TrainedModels/TrainDataset/TrainDataset/densenet_emotiw_pretrainemotic_lr001.pt', map_location=lambda storage, loc: storage))
...
class FaceAttention(nn.Module):
    ...
    def forward(self, face_features_initial, numberFaces, labels):
        ...
        # numberFaces = numberFaces.data.cpu().numpy()  ##后加
...
aligned_model_image_level_path = '../TrainedModels/TrainDataset/TrainDataset/AlignedModel_EmotiW_lr01_Softmax'
...
model5 = torch.load('../TrainedModels/TrainDataset/TrainDataset/PretrainedDenseNet-FineTune-2208-3-lr001-Regularized-Corrected', map_location=lambda storage, loc: storage).module
...
model6 = torch.load('../TrainedModels/TrainDataset/TrainDataset/FaceAttention_AlignedModel_FullTrain_3para_lr001_dropout_BN_SoftmaxLr01_EmotiC', map_location=lambda storage, loc: storage).module
...
model7 = torch.load('../TrainedModels/TrainDataset/TrainDataset/FaceAttention_AlignedModel_FullTrain_4para_lr001_dropout_BN_SoftmaxLr01_EmotiC', map_location=lambda storage, loc: storage).module
...
model8 = torch.load('../TrainedModels/TrainDataset/TrainDataset/FaceAttention_AlignedModel_FullTrain_4para_lr01_dropout_BN_SoftmaxLr01', map_location=lambda storage, loc: storage).module
...
aligned_model_global_level_path = "../TrainedModels/TrainDataset/TrainDataset/AlignedModelTrainerSoftmax_AlignedModel_EmotiW_lr01_Softmax_br128"
align_model = torch.load(aligned_model_global_level_path, map_location=lambda storage, loc: storage).module
model9 = align_model
...
aligned_model_global_level_path = "../TrainedModels/TrainDataset/TrainDataset/AlignedModelTrainerLSoftmax_AlignedModel_EmotiW_lr001"
align_model = torch.load(aligned_model_global_level_path, map_location=lambda storage, loc: storage).module
model10 = align_model
...
model11 = torch.load('../TrainedModels/TrainDataset/TrainDataset/FaceAttention_AlignedModel_FullTrain_lr001_dropout_BN_SoftmaxLr01', map_location=lambda storage, loc: storage).module
...
model12 = torch.load('../TrainedModels/TrainDataset/TrainDataset/FaceAttention_AlignedModel_FullTrain_3para_lr001_dropout_BN_SoftmaxLr01', map_location=lambda storage, loc: storage).module
...
model13 = torch.load('../TrainedModels/TrainDataset/TrainDataset/FaceAttention_AlignedModel_FullTrain_4para_lr01_dropout_BN_SoftmaxLr01_EmotiC', map_location=lambda storage, loc: storage).module
...
model14 = torch.load('../TrainedModels/TrainDataset/TrainDataset/FaceAttention_AlignedModel_FullTrain_4para_adam_dropout_BN_SoftmaxLr01', map_location=lambda storage, loc: storage).module

...
model_ft = torch.load('../TrainedModels/TrainDataset_my_models_wzq/model_skeleton_densenet_New_data2.pt', map_location=lambda storage, loc: storage)

print('Skeleton Densenet161 Loaded! (Model 3)')
...
def train_model(model, criterion, optimizer=None, scheduler=None, num_epochs=1):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(0, 3):
            ...
            np.savez('model3_Skeleton_densenet_output_data',

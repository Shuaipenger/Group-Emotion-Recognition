...
if __name__ == "__main__":
    ...
    start = time.time()
    videos_path = '/home/prmi/GSP/Group-Level-Emotion-Recognition-master/Dataset/wzq_dataset/val/negative_video'
    outfile = '/home/prmi/GSP/Group-Level-Emotion-Recognition-master/Dataset/wzq_dataset/val/negative/'  # 处理完的帧

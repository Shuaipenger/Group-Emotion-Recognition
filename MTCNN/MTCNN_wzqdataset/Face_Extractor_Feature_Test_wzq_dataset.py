...
processed_dataset_path = '../Dataset/wzq_dataset/test/'
...
test_neg = sorted(os.listdir('../Dataset/wzq_dataset/test/Negative/'))
test_pos = sorted(os.listdir('../Dataset/wzq_dataset/test/Positive/'))
test_data_filelist = test_neg + test_pos

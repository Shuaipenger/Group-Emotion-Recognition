...
model5 = torch.load('../TrainedModels/TrainDataset_my_models_wzq/model_5_1_All_New_data', map_location=lambda storage, loc: storage)
...
def train_model(model, criterion, optimizer=None, scheduler=None, num_epochs=25):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(0, 3):
            ...
            np.savez('model5_output_data_onecrossvit',

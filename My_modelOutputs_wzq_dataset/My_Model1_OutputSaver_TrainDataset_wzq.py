...
model_ft = torch.load('../TrainedModels/TrainDataset_my_models_wzq/model_1_1_densenet_New_data', map_location=lambda storage, loc: storage)
model_ft = model_ft.to(device)
model_ft = nn.DataParallel(model_ft)
print('DenseNet161 Loaded! (Model 1)')
...
def train_model(model, criterion, optimizer=None, scheduler=None, num_epochs=1):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(0, 3):
            ...
            np.savez('model1_0_Scene_Densenet_output_data',

...
# MODEL DEFINITION
#---------------------------------------------------------------------------
model_ft = torch.load('../TrainedModels/TrainDataset_my_models_wzq/model_1_1_densenet_New_data_Face.pt', map_location=lambda storage, loc: storage)
...
def train_model(model, criterion, optimizer=None, scheduler=None, num_epochs = 1):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(0,3):
            ...
            np.savez('model_output_data_Densenet_Face',

...
model_ft = torch.load('../TrainedModels/TrainDataset_my_models_wzq/model_2_1_resnet18_EmotiW_wzq', map_location=lambda storage, loc: storage)

print('Scene resnet18 Loaded! (Model 2)')
...
def train_model(model, criterion, optimizer=None, scheduler=None, num_epochs=1):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(0, 3):
            ...
            np.savez('model2_Scene_resnet_output_data',

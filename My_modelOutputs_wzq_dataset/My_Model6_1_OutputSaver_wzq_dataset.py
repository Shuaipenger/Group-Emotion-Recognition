...
model6_1 = torch.load('../TrainedModels/TrainDataset_my_models_wzq/model_6_2A_All_New_data', map_location=lambda storage, loc: storage)
...
def train_model(model, criterion, optimizer=None, scheduler=None, num_epochs=1):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(0, 3):
            ...
            np.savez('model6_2A_output_data',
                     output_train_model1=output_train_model6_1,
                     output_valid_model1=output_valid_model6_1,
                     output_test_model1=output_test_model6_1,

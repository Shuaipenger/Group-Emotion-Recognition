...
path_output_data1 = '../My_modelOutputs_wzq_dataset/model6_2A_output_data.npz'
path_output_data2 = '../My_modelOutputs_wzq_dataset/model_output_data_Densenet_No_Face2.npz'
...
model1_test = data1['output_test_model1']

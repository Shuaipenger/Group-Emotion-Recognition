...
neg_train = sorted(os.listdir('../Dataset/wzq_dataset7:2:1/val/'+'Negative/'))
pos_train = sorted(os.listdir('../Dataset/wzq_dataset7:2:1/val/'+'Positive/'))
...
renet_model.fc =nn.Linear(512,2)
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(2):
            ...
            if phase == 1 and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(renet_model, '../TrainedModels/TrainDataset_my_models_wzq/model_2_1_resnet18_EmotiW_wzq')
            if phase == 0:
                scheduler.step()  # 改动
        print()

...
model_ft.fc6 = nn.Linear(512,3)   #将LSoftmaxLoss()换成 linear()
...
def train_model(model, criterion, optimizer, scheduler, num_epochs = 25):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(2):
            ...
            epoch_loss = running_loss / (dataset_sizes[phase] *maxFaces)     # 更改过
            epoch_acc = running_corrects.double() / (dataset_sizes[phase] *maxFaces)  # 更改过
...
torch.save(model_ft, '../TrainedModels/TrainDataset/AlignedModel_EmotiW_lr01_Softmax')

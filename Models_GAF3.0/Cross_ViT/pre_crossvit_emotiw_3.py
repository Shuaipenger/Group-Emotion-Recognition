    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(2):
            ...
            if phase == 1 and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model, '../TrainedModels/TrainDataset/pre_crossvit_emotiw_3')
...
torch.save(model_ft.state_dict(), "../TrainedModels/pre_crossvit_emotiw_3_state.pt")
torch.save(model_ft, '../TrainedModels/pre_crossvit_emotiw_3')